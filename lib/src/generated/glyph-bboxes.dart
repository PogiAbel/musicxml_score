...
class GlyphBBox {
    ...
    GlyphBBox operator +(Offset other) {
        return GlyphBBox(
            Offset(northEast.dx + other.dx, northEast.dy + other.dy),
            Offset(southWest.dx + other.dx, southWest.dy + other.dy)
        );
    }

    GlyphBBox operator *(double factor) {
        return GlyphBBox(
            Offset(northEast.dx * factor, northEast.dy * factor),
            Offset(southWest.dx * factor, southWest.dy * factor)
        );
    }
}
